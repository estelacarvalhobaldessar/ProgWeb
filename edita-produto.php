...
if(empty($_GET["id"])){
 ...
 $msg = "Produto cadastrado com Suceso!!";
}
include("connect.php");
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $sql = "UPDATE produtos SET nome = :nome, categoria = :categoria, preco = :preco, tamanho = :tamanho, cor = :cor, descricao = :descricao, marca = :marca WHERE id = :id";
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <textarea name="descricao" id="descricao"
                                            class="form-control" 
                                            required><?php echo htmlspecialchars($produto['descricao']); ?>
                                        </textarea>
                                        <div class="invalid-feedback">
                                     ...
                                     <!-- Campo tamanho -->
                                        <?php
                                        //inicializa todas as opcoes vazias
                                        $tamanhos = ['PP' => '','P' => '','M' => '','G' => '','GG'=> '','XG'=> ''] ;
                                        //marca a opcao correspondenteao tamanho do produto
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <div class="invalid-feedback">
                                            Por favor, insira a tamanho do produto.
                                        </div>
                                    </div> 
