...
// Busca a lista de produtos
    ...
    $listaCliente = $stmt->fetchAll();
    //var_dump($listaCliente);
    $qtd_prod = count($listaCliente);

                        for($i=0;$i<$qtd_prod;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            <td>".$listaCliente[$i]["id"]."</td>
                                            <td>".$listaCliente[$i]["nome"]."</td>
                                            <td><span class=\"badge text-bg-primary\">".$listaCliente[$i]["email"]."</span></td>
                                            <td>".$listaCliente[$i]["telefone"]."</td>

                                            <td class=\"text-center\">
                                                <a href=\"edita-cliente.php?id=".$listaCliente[$i]["id"]."\" class=\"btn btn-primary btn-sm\" title=\"Editar\">
                                                    <i class=\"bi bi-pencil\"></i>
                                                <a href=\"exclui-cliente.php?id=".$listaCliente[$i]["id"]."\" class=\"btn btn-danger btn-sm\"
