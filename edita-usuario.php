                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">Edita Produto :: <?php echo $usuario["id"]. "|" .$usuario["nome"]; ?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            ...
                            <!-- Campo oculto para o ID -->
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <textarea name="email" id="email"
                                            class="form-control" 
                                            required><?php echo htmlspecialchars($usuario['email']); ?>
                                        </textarea>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="senha" name="senha" 
                                            ...
                                            required>
                                        <div class="invalid-feedback">
                                            Por favor, insira a senha do seu usuário .
                                        </div>
                                    </div>
